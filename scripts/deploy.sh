...
source ~/.bashrc
sudo nohup java -jar $DEPLOY_JAR --jasypt.encryptor.password=$JASYPT_PASSWORD >> /home/ec2-user/orury/log/tomcat.log 2>/home/ec2-user/orury/log/deploy_error.log &