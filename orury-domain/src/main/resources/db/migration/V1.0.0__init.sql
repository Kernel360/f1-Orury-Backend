...
ALTER TABLE `post_like`
    ADD CONSTRAINT `PK_POST_LIKE` PRIMARY KEY (
                                               `user_id`,
                                               `post_id`
        );
...
ALTER TABLE `post_like`
    ADD CONSTRAINT `FK_user_TO_post_like_1` FOREIGN KEY (
                                                         `user_id`
        )
        REFERENCES `user` (
                           `id`
...
ALTER TABLE `post_like`
    ADD CONSTRAINT `FK_post_TO_post_like_1` FOREIGN KEY (
                                                         `post_id`
        )
        REFERENCES `post` (
                           `id`
...
ALTER TABLE `comment_like`
    ADD CONSTRAINT `FK_user_TO_comment_like_1` FOREIGN KEY (
                                                            `user_id`
        )
        REFERENCES `user` (
                           `id`
