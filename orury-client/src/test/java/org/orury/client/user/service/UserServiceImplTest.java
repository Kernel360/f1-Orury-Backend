...
//import org.orury.domain.user.domain.UserServiceImpl;
...
//
//        userServiceImpl = new UserServiceImpl(userRepository, imageUtils, postRepository, postLikeRepository, commentRepository, commentLikeRepository, reviewRepository, reviewReactionRepository, gymRepository, gymLikeRepository);
//    }
//
//    @Test
...
//
//        // when
//        userServiceImpl.updateProfileImage(userDto, file);
//
//        // then
...
//        // when
//        userServiceImpl.updateProfileImage(userDto, file);
//        userServiceImpl.updateProfileImage(userDto, emptyFile);
//
//        // then
