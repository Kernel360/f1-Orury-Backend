...
import org.fastcampus.oruryclient.review.util.ReviewMessage;
...
public class ReviewController {
    ...
    public ApiResponse<Object> updateReview(@PathVariable Long reviewId, @RequestBody ReviewUpdateRequest request) {
        ...
        reviewService.isValidate(beforeReviewDto.userDto().id(), userDto.id());
    ...
    public ApiResponse<Object> deleteReview(@PathVariable Long reviewId) {
        ...
        reviewService.isValidate(userDto.id(), reviewDto.userDto().id());
