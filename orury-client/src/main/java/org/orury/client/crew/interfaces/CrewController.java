...
public class CrewController {
    ...
    @GetMapping("/rank")
    public ApiResponse getCrewsByRank(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestParam int page) {
        WithPageResponse<CrewsResponseByRank> pageResponse = crewFacade.getCrewsByRank(page);
    ...
    public ApiResponse getCrewsByRecommendation(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestParam int page) {
        WithPageResponse<CrewsResponseByRecommend> pageResponse = crewFacade.getCrewsByRecommend(page);
    ...
    @GetMapping("/mycrew")
    public ApiResponse getMyCrews(@AuthenticationPrincipal UserPrincipal userPrincipal, @RequestParam int page) {
        WithPageResponse<CrewsResponseByMyCrew> pageResponse = crewFacade.getMyCrews(userPrincipal.id(), page);
    ...
    @GetMapping("/{crewId}")
    public ApiResponse getCrewByCrewId(@AuthenticationPrincipal UserPrincipal userPrincipal, @PathVariable Long crewId) {
