...
public class MeetingController {
    ...
    @Operation(summary = "모임 생성", description = "MeetingCreateRequest를 받아, 모임을 생성한다.")
    ...
    @Operation(summary = "모임 수정", description = "MeetingUpdateRequest를 받아, 모임을 수정한다.")
    ...
    @Operation(summary = "모임 삭제", description = "meetingId를 받아, 모임을 삭제한다.")
    ...
    @Operation(summary = "모임멤버 추가", description = "meetingId를 받아, 모임멤버를 추가한다.")
    ...
    @Operation(summary = "모임멤버 제거", description = "meetingId를 받아, 모임멤버를 제거한다.")
    ...
    @Operation(summary = "모임멤버 목록 조회", description = "meetingId를 받아, 모임멤버 목록을 조회한다.")
